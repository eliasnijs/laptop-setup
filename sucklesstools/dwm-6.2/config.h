...
static const unsigned int borderpx  = WM_BORDER_WIDTH;
static const unsigned int gappx     = WM_GAP_WIDTH;
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { WM_COL_SEL_FG,  WM_COL_SEL_BG,  WM_COL_SEL_BORDER },
};
...
static const char *dmenucmd[]		= { "dmenu_run", "-m", dmenumon, "-fn", WM_FONT, "-nb", WM_COL_DMENU_NB, "-nf", WM_COL_DMENU_NF, "-sb", WM_COL_DMENU_SB, "-sf", WM_COL_DMENU_SF, NULL };
