...
#define WM_COL_NORM_FG		"#444444"   /* non selected workspace foreground color */
#define WM_COL_NORM_BG		"#F6F5F4"   /* non selected workspace background color */
#define WM_COL_SEL_FG		"#00b300"   /* selected workspace foreground color */
#define WM_COL_SEL_BG		"#F6F5F4"   /* selected workspace background color */

#define WM_COL_NORM_BORDER  	"#999999"   /* non selected window border color */
#define WM_COL_SEL_BORDER  	"#00b300"   /* selected window border color */

#define WM_COL_DMENU_NB  	"#F6F5F4"   /* dmenu normal background color */
#define WM_COL_DMENU_NF  	"#444444"   /* dmenu normal foreground color */
#define WM_COL_DMENU_SB  	"#F6F5F4"   /* dmenu selected background color */
#define WM_COL_DMENU_SF  	"#00b300"   /* dmenu selected foreground color */
#define WM_COL_DMENU_OB		"#F6F5F4"   /* dmenu already selected background color */
#define WM_COL_DMENU_OF		"#006300"   /* dmenu already selected foreground color */
