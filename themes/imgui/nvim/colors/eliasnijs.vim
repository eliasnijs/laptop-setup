...
let s:default =       ['#dddddd', 137]
let s:margin =        ["#262626", 235]
let s:margin_hover =  ["#333333", 236]
let s:margin_active = ["#404040", 238]
let s:cursor =        ["#4296FA", 83]
let s:highlight =     ["#000088", 58]
let s:at_highlight =  ["#dddddd", 180]
let s:mark =          ["#808080", 244]
let s:comment =       ["#7D7D7D", 244]
let s:keyword =       ["#4296FA", 172]
let s:constant =      ["#4c87d9", 64]
let s:preproc =       ["#ccccff", 180]
let s:special =       ["#FF0000", 196]
let s:note =          ["#FF0000", 196]
