...
" SOURCE: Based on `vim-handmade-hero`, which is based on the theme used by Casey Muratori on handmade hero
...
" Colors
let s:back =          ['#00000000', 0]
let s:default =       ['#CCCCCC', 137]
let s:margin =        ["#262626", 235]
let s:margin_hover =  ["#333333", 236]
let s:margin_active = ["#404040", 238]
let s:cursor =        ["#40FF40", 83]
let s:highlight =     ["#CCCCCC", 58]
let s:at_highlight =  ["#000000", 180]
let s:mark =          ["#808080", 244]
let s:comment =       ["#CCCCCC", 244]
let s:keyword =       ["#CCCCCC", 172]
let s:constant =      ["#CCCCCC", 64]
let s:preproc =       ["#CCCCCC", 180]
let s:special =       ["#CCCCCC", 196]
let s:note =          ["#CCCCCC", 196]
...
call s:HL('Cursor',       s:cursor,          s:cursor)
call s:HL('Comment',      s:comment,       s:back)
call s:HL('Todo',         s:note,          s:back)
