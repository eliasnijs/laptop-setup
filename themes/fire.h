...
#define WM_COL_SEL_FG		"#ff0004"   /* selected workspace foreground color */
...
#define WM_COL_SEL_BORDER  	"#ff0004"   /* selected window border color */

#define WM_COL_DMENU_NB  	"#000000"   /* dmenu normal background color */
#define WM_COL_DMENU_NF  	"#FFFFFF"   /* dmenu normal foreground color */
#define WM_COL_DMENU_SB  	"#ff0004"   /* dmenu selected background color */
#define WM_COL_DMENU_SF  	"#FFFFFF"   /* dmenu selected foreground color */
#define WM_COL_DMENU_OB		"#c11f1f"   /* dmenu already selected background color */
