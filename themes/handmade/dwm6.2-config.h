...
static const char col_gray2[]       = "#3E3E47";
static const char col_gray4[]       = "#CDAA7D";
static const char col_cyan[]        = "#CD950C";
static const char col_cyan2[]	    = "#40FF40";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray4,  col_gray1,  col_gray2  },
	[SchemeSel]  = { col_cyan, col_gray1,  col_cyan2  },
};
...
static const char *bluetoothctl[]	= { "st", "-t", "bluetoothctl", "-e", "bluetoothctl" , NULL };

static Key keys[] = {
	/* modifier                     key		function        argument */
	{ MODKEY|ShiftMask,             XK_semicolon,	spawn,          {.v = bluetoothctl } },
